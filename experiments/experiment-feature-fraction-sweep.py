...
def main():
    ...
    cli.add_argument("--base-seed", type = int, default = 2380)
    cli.add_argument("--epochs", type = int, default = 40)
    ...
    cli.add_argument("--za-plot-model-version", type = int, default = 0)
    cli.add_argument("--max-bag-size", type = int, default = None)
    cli.add_argument("--min-tumor-fraction", type = float, default = 0.01)
